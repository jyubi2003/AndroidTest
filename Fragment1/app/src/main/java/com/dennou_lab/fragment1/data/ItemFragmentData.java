 ...
 */
public class ItemFragmentData extends ArrayAdapter<TranContent.TranItem> {
     ...
     * constructor
     */
    public ItemFragmentData(Context context, int textViewResourceId, List<TranContent.TranItem> objects){
